...
Usage (example):
    $ python main.py --wave 193 --normal 0,1,1 --radius 200 --width 2 \
                    --rho npz/rho.npz --Te npz/Te.npz --domain-left 1,0,0 --domain-right 3,pi,2*pi
"""
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--wave", type=int, default=193, choices=[94, 131, 171, 193, 211, 304, 335])
...
def main() -> None:
    ...
    # ‑‑‑ Optical properties
    kai = absorption_EUV(Te, rho, args.wave, 7e10)
    J = radiation_EUV(Te, rho, args.wave, 7e10)
